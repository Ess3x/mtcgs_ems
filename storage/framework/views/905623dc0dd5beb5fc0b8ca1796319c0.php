<?php $__env->startSection('title', 'Payslip - ' . $entry->employeeProfile->first_name . ' ' . $entry->employeeProfile->last_name); ?>
                ...
                <div class="payslip-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <div class="period-info">
                                    <?php echo e($entry->payrollPeriod?->name ?? 'Payroll Period'); ?>
                            ...
                            <div class="col-auto text-right">
                                ...
                                <strong style="font-size: 16px;">
                                    <?php echo e($entry->payrollPeriod?->start_date?->format('M d') ?? '--'); ?> - 
                                    <?php echo e($entry->payrollPeriod?->end_date?->format('M d, Y') ?? '--'); ?>
                    ...
                    <div class="payslip-body">
                        <div class="attendance-summary-grid">
                            <div class="attendance-summary-card">
                                ...
                                <div class="value"><?php echo e($dtrStats['days_present'] ?? 0); ?></div>
                            </div>
                            <div class="attendance-summary-card">
                                <div class="label">Total Day Absent</div>
                                <div class="value"><?php echo e($dtrStats['days_absent'] ?? 0); ?></div>
                            </div>
                            <div class="attendance-summary-card">
                                <div class="label">Late Minutes</div>
                                <div class="value"><?php echo e($dtrStats['late_minutes'] ?? 0); ?></div>
                            </div>
                            <div class="attendance-summary-card">
                                <div class="label">Early Out Minutes</div>
                                <div class="value"><?php echo e($dtrStats['early_out_minutes'] ?? 0); ?></div>
                            </div>
                            <div class="attendance-summary-card">
                                <div class="label">Paid Leave</div>
                                <div class="value"><?php echo e($dtrStats['paid_leave'] ?? 0); ?></div>
                            </div>
                            <div class="attendance-summary-card">
                                <div class="label">Leave Without Pay</div>
                                <div class="value"><?php echo e($dtrStats['leave_without_pay'] ?? 0); ?></div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="info-row">
                                        ...
                                        <span class="info-value"><?php echo e($entry->employeeProfile->first_name); ?> <?php echo e($entry->employeeProfile->last_name); ?></span>
                                    </div>
                                    <div class="info-row">
                                        <span class="info-label">Employee ID:</span>
                                        <span class="info-value"><?php echo e($entry->employeeProfile->employee_number); ?></span>
                                    </div>
                                    <div class="info-row">
                                        <span class="info-label">Position:</span>
                                        <span class="info-value"><?php echo e($entry->employeeProfile->position ?? 'N/A'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="info-row">
                                        ...
                                        <span class="info-value"><?php echo e($entry->branch?->branch_name ?? $entry->employeeProfile?->branch?->branch_name ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="info-row">
                                        <span class="info-label">Status:</span>
                                        <span class="info-value">
                                            <span class="status-badge status-<?php echo e($entry->status); ?>">
                                                <?php echo e($isApprovedPayroll ? ($entry->payrollPeriod?->admin_approval_stage === 'hr_fd' ? 'Approved HR/FD' : 'Finance Head Approved') : ucfirst($entry->payrollPeriod?->status ?? $entry->status)); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 earnings-col">
                                    ...
                                    <div class="item-row">
                                        ...
                                        <span class="item-value">₱<?php echo e(number_format($entry->basic_pay, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Daily Rate</span>
                                        <span class="item-value">₱<?php echo e(number_format($dailyRate, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Total Daily Rate</span>
                                        <span class="item-value">₱<?php echo e(number_format($totalDailyRate, 2)); ?></span>
                                    </div>
                                    <?php if($entry->overtime_pay > 0): ?>
                                    <div class="item-row">
                                        <span class="item-label">Overtime (<?php echo e(number_format($entry->overtime_hours, 2)); ?> hrs)</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->overtime_pay, 2)); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($entry->allowances > 0): ?>
                                    <div class="item-row">
                                        <span class="item-label">Allowances</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->allowances, 2)); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <?php if($entry->bonuses > 0): ?>
                                    <div class="item-row">
                                        <span class="item-label">Bonuses</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->bonuses, 2)); ?></span>
                                    </div>
                                    <?php endif; ?>
                                    <div class="total-row" style="color: #28a745; border-top-color: #28a745; border-bottom-color: #28a745;">
                                        <span>Gross Pay</span>
                                        <span>₱<?php echo e(number_format($entry->gross_pay, 2)); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 deductions-col">
                                    ...
                                    <div class="item-row">
                                        ...
                                        <span class="item-value">₱<?php echo e(number_format($entry->late_deduction, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Absent Deduction</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->absent_deduction, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Early Out Deduction</span>
                                        <span class="item-value">₱<?php echo e(number_format($earlyOutDeduction, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Leave Deduction</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->leave_deduction ?? 0, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Leave Without Pay (<?php echo e($leaveWithoutPayDays); ?> days)</span>
                                        <span class="item-value">₱<?php echo e(number_format($leaveWithoutPayDeduction, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">SSS</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->sss_contribution ?? 0, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">PhilHealth</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->philhealth_contribution ?? 0, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Pag-IBIG</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->pagibig_contribution ?? 0, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Withholding Tax</span>
                                        <span class="item-value">₱<?php echo e(number_format($entry->withholding_tax ?? 0, 2)); ?></span>
                                    </div>
                                    <div class="item-row">
                                        <span class="item-label">Cash Advance Deduction</span>
                                        <span class="item-value">₱<?php echo e(number_format($cashAdvanceDeduction, 2)); ?></span>
                                    </div>
                                    <div class="total-row" style="color: #dc3545; border-top-color: #dc3545; border-bottom-color: #dc3545;">
                                        <span>Total Deductions</span>
                                        <span>₱<?php echo e(number_format($entry->total_deductions, 2)); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="net-pay-section">
                            ...
                            <div class="amount">₱<?php echo e(number_format($entry->net_pay, 2)); ?></div>
                        </div>
                        ...
                        <div class="attendance-summary">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="stat-box">
                                        <div class="number"><?php echo e($entry->days_present ?? 0); ?></div>
                                        <div class="label">Days Present</div>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="stat-box">
                                        <div class="number"><?php echo e($entry->dtr->early_out_minutes ?? 0); ?></div>
                                        <div class="label">Early Out Minutes</div>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="stat-box">
                                        <div class="number"><?php echo e($paidLeaveDays); ?></div>
                                        <div class="label">Paid Leave</div>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="stat-box">
                                        <div class="number"><?php echo e($leaveWithoutPayDays); ?></div>
                                        <div class="label">Leave Without Pay</div>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="stat-box">
                                        <div class="number"><?php echo e($entry->days_absent ?? 0); ?></div>
                                        <div class="label">Days Absent</div>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="stat-box">
                                        <div class="number"><?php echo e(number_format($entry->overtime_hours ?? 0, 1)); ?></div>
                                        <div class="label">OT Hours</div>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="stat-box">
                                        <div class="number"><?php echo e($entry->dtr->late_minutes ?? 0); ?></div>
                                        <div class="label">Late Minutes</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payslip-footer">
                        <div class="footer-info">
                            Generated: <strong><?php echo e(now()->format('M d, Y @ H:i A')); ?></strong>
                        </div>
                        <div class="action-buttons">
                            <?php if(Auth::user()->role === 'admin' || Auth::user()->role === 'finance'): ?>
                            <a href="<?php echo e(route('admin.payroll.entries', ['periodId' => $entry->payroll_period_id])); ?>" class="btn-custom btn-back">← Back to Payroll</a>
                            <?php else: ?>
                            <a href="<?php echo e(route('employee.payslips')); ?>" class="btn-custom btn-back">← Back to Payslips</a>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mtcgs-main_09-06-26\mtcgs-ems\resources\views\admin\payroll\payslip.blade.php ENDPATH**/ ?>