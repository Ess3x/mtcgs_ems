...
function demoAttCompleteScan() {
    ...
    // Simulate API call
    fetch('<?php echo e(route("admin.unified-demo.attendance")); ?>', {
        method: 'POST',
        headers: {
...
</style><?php /**PATH C:\xampp\htdocs\mtcgs-main_09-06-26\mtcgs-ems\resources\views\admin\demo\attendance-recording.blade.php ENDPATH**/ ?>