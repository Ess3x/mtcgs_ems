        ...
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="fs-3 fw-bold"><?php echo e($devices->count()); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="fs-3 fw-bold text-success"><?php echo e($devices->where('status', 'active')->count()); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="fs-3 fw-bold text-warning"><?php echo e($devices->where('status', 'maintenance')->count()); ?></div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="fs-3 fw-bold text-danger"><?php echo e($devices->where('status', 'inactive')->count()); ?></div>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <span class="badge bg-<?php echo e($statusClass); ?> text-uppercase"><?php echo e($device->status); ?></span>
                                </td>
                                <td><?php echo e($device->last_used_at ? $device->last_used_at->format('M d, Y h:i A') : 'Never'); ?></td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="<?php echo e(route('admin.devices.edit', $device)); ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <form action="<?php echo e(route('admin.devices.destroy', $device)); ?>" method="POST" onsubmit="return confirm('Remove this device from the authorized list?');">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\STUDENT\Desktop\mtcgs_ems\resources\views\admin\devices\index.blade.php ENDPATH**/ ?>