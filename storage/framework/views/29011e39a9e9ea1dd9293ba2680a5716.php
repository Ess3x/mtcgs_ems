<?php $__env->startSection('title', 'Create Branch Admin Account'); ?>
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-user-plus me-2"></i>Create New Branch Admin Account</h4>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('admin.branch-heads.store')); ?>" method="POST" class="needs-validation">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['employee_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    id="employee_number" name="employee_number" value="<?php echo e(old('employee_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    id="position" name="position" value="<?php echo e(old('position', 'Branch Administrator')); ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control <?php $__errorArgs = ['basic_salary'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        id="basic_salary" name="basic_salary" value="<?php echo e(old('basic_salary', 0)); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control <?php $__errorArgs = ['date_hired'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="alert alert-info mb-3">
                            ...
                            <strong>Note:</strong> A temporary password will be generated and sent to the provided email address.
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\STUDENT\Desktop\mtcgs_ems\resources\views\admin\branch-heads\create.blade.php ENDPATH**/ ?>