    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <?php if(session('photo_updated')): ?>
                        <div class="alert alert-success py-2" role="alert">
                            <i class="fas fa-check-circle me-1"></i><?php echo e(session('photo_updated')); ?>

                        </div>
                    <?php endif; ?>
                    <?php if($profile && $profile->profile_photo): ?>
                        <div class="text-center mb-3">
                            <img src="<?php echo e(route('profile.photo', [strtolower(class_basename($profile)), $profile->id]) . '?v=' . $profile->updated_at?->timestamp); ?>" alt="Profile photo" class="rounded-circle border" style="width: 140px; height: 140px; object-fit: cover;">
                        </div>
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('profile.photo.save')); ?>" enctype="multipart/form-data" class="mb-4">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mtcgs-main_09-06-26\mtcgs-ems\resources\views/profile.blade.php ENDPATH**/ ?>