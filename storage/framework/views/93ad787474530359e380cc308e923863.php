                ...
                <div class="card-header bg-transparent border-0 d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 py-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <?php if(Auth::user()->isBranchAdmin() || Auth::user()->isSuperAdmin()): ?>
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->isSuperAdmin() && $pendingCount > 0): ?>
                                <form method="POST" action="<?php echo e(route('admin.dtr.submit-all-to-finance-head')); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mtcgs-main_09-06-26\mtcgs-ems\resources\views/admin/dtr/index.blade.php ENDPATH**/ ?>