...
class TestEmployeeSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->command->info('Email: ghost.employee@test.com');
    ...
    {
        // Create payroll period for current month - use FirstOrCreate
        ...
        $grossPay = $basicPay + 500; // Base pay + small bonus
        $overtimePay = 1000; // Overtime pay
        ...
        $netPay = ($basicPay + $overtimePay) - $totalDeductions;
