        ...
        * { box-sizing: border-box; }
        ...
        body {
            ...
            background:
                ...
                url('{{ asset('images/homepage-bg.jpg') }}') center center / cover no-repeat fixed;
...
<body>
    <nav class="navbar navbar-expand-lg sticky-top shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="{{ url('/') }}">
                <img src="{{ asset('images/logo.jpg') }}" alt="MTCGS" style="max-height: 64px; width: auto;" onerror="this.style.display='none'">
            ...
            <div class="collapse navbar-collapse" id="landingNavbar">
                ...
                <div class="d-flex align-items-center gap-2 mt-2 mt-lg-0">
                    ...
                    <a href="{{ route('login') }}" class="btn btn-cta btn-sm px-3">
                    ...
                    <div class="p-4 contact-card">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-md-4 text-md-end">
                                <a href="{{ route('login') }}" class="btn btn-cta px-4">
                                    <i class="fas fa-sign-in-alt me-1"></i>Login
                                </a>
                            </div>
                        </div>
    ...
    <footer class="page-footer">
        <div class="container text-center">
            ...
            <p class="text-muted small mb-0 mt-2">&copy; {{ date('Y') }} MTCGS - All rights reserved</p>
        </div>
    </footer>
