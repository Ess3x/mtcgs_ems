                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-circle bg-{{ $event->event_type === 'activity' ? 'primary' : 'warning' }} text-white me-3">
                                                    <i class="fas fa-{{ $event->event_type === 'activity' ? 'graduation-cap' : 'umbrella-beach' }}"></i>
                                                </div>
                                                <div>
                                        ...
                                        <td>
                                            <span class="badge bg-{{ $event->event_type === 'activity' ? 'primary' : 'warning' }}">
